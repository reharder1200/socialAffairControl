...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/social/secOrder/">订单列表</a></li>
		<li class="active"><a href="${ctx}/social/secOrder/form?id=${secOrder.id}">订单<shiro:hasPermission name="social:secOrder:edit">${not empty secOrder.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="social:secOrder:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="secOrder" action="${ctx}/social/secOrder/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="social:secOrder:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
