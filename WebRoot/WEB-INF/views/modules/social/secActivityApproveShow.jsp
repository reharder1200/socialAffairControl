...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a>活动审核详情</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="secActivity" action="${ctx}/social/secActivity/approve" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<input type="hidden" name="state" id="state" value="${secActivity.state }"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">标题：</label>
			<div class="controls">
				<form:input path="title" htmlEscape="false" maxlength="50" class="input-xlarge required" disabled="true"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="minPeople" htmlEscape="false" maxlength="15" class="input-xlarge required" disabled="true"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="maxPeople" htmlEscape="false" maxlength="15" class="input-xlarge required" disabled="true"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<%-- <div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="location" htmlEscape="false" maxlength="100" class="input-xlarge " disabled="true"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">位置详情：</label>
			<div class="controls">
				<form:input path="locationDetatil" htmlEscape="false" maxlength="100" class="input-xlarge " disabled="true"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">经度：</label>
			<div class="controls">
				<form:input path="activityLat" htmlEscape="false" maxlength="200" class="input-xlarge required" disabled="true"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="activityLon" htmlEscape="false" maxlength="200" class="input-xlarge required" disabled="true"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="chargeType" class="input-xlarge required" disabled="true">
					<form:option value="" label="请选择"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="chargeAmount" htmlEscape="false" maxlength="20" class="input-xlarge required" disabled="true"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="activityDescription" htmlEscape="false" rows="4" maxlength="500" class="input-xxlarge required" disabled="true"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="contactWx" htmlEscape="false" maxlength="100" class="input-xlarge required" disabled="true"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="contactMobile" htmlEscape="false" maxlength="20" class="input-xlarge required" disabled="true"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="activityStatus" class="input-xlarge required" disabled="true">
					<form:option value="" label="请选择"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="depositStatus" class="input-xlarge required" disabled="true">
					<form:option value="" label="请选择"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="orderId" htmlEscape="false" maxlength="100" class="input-xlarge " disabled="true"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">活动发起人：</label>
			<div class="controls">
				<form:select path="activityStarter.id" class="input-xlarge required" disabled="true">
					<form:option value="" label="请选择"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="remarks" htmlEscape="false" rows="4" maxlength="500" class="input-xxlarge " disabled="true"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">审批意见：</label>
			<div class="controls">
				<form:textarea path="additOpinion" htmlEscape="false" rows="4" maxlength="500" class="input-xxlarge required" disabled="true"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="form-actions">
			<%-- <shiro:hasPermission name="social:secActivity:approve"><input id="btnSubmit" class="btn btn-primary" type="button" onclick="dealActivity(2)" value="审核通过"/>&nbsp;</shiro:hasPermission>
			<shiro:hasPermission name="social:secActivity:approve"><input id="btnSubmit" class="btn btn-primary" type="button" onclick="dealActivity(1)" value="审核不通过"/>&nbsp;</shiro:hasPermission> --%>
